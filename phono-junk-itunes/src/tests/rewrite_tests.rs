...
fn rewrites_jpg_100_to_1000() {
    let input = "https://is1-ssl.mzstatic.com/image/thumb/Music/v4/00/source/100x100bb.jpg";
...
fn rewrites_png_100_to_1000() {
    let input = "https://is1-ssl.mzstatic.com/image/thumb/Music/v4/00/source/100x100bb.png";
    let out = rewrite_artwork_size(input);
